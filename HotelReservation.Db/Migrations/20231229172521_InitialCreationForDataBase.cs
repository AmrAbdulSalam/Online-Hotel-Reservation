...
{
    /// <inheritdoc />
    public partial class InitialCreationForDataBase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReferenceceNo = table.Column<int>(type: "int", nullable: false),
                    IsFeaturedDeal = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_ReferenceceNo",
                table: "Reservations",
                column: "ReferenceceNo",
                unique: true);
